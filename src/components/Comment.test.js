...
describe('Comment', () => {
  test('simple Comment', () => {
    expect(
      render(<test><Comment>this is sample comment</Comment></test>, commonOptions),
    )
  ...
  test('simple Comment with variables', () => {
    expect(
      render(<test><Comment>1 + {2} = {3}</Comment></test>, commonOptions),
    )
  ...
  test('comment can not use embed element', () => {
    expect(
      () => { render(<test><Comment>1 + {<number>2</number>} = {3}</Comment></test>, commonOptions) },
    ).toThrow()
  })
  ...
  test('simple Comment with variables', () => {
    ...
    expect(
      render(<test><Comment>1 + {<ToFixed number={2} />} = {3}</Comment></test>, commonOptions),
    )
